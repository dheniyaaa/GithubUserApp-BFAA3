...
import com.example.submission3.databinding.ItemUserBinding

class ListUserAdapter(private val listener: (UserModel) -> Unit) :RecyclerView.Adapter<ListUserAdapter.ListViewHolder>() {
